...
public class RepresentativeDashboard extends JFrame{
	...
	private void initialize() {
		...
		btnQuery.setBounds(10, 172, 288, 43);
		...
		JButton btnRequestService = new JButton("Assign Complaint");
		...
		btnRequestService.setBounds(10, 260, 288, 43);
		...
		button_1.setBounds(10, 428, 288, 43);
		button_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
                ...
                if (answer == JOptionPane.YES_OPTION) {
                    ...
                    LOGGER.info("Logged in successfully to chat from Representative dashboard.");
                }
                dispose();
                Login login = new Login();
